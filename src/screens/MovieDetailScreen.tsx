...
import { View, ScrollView, Text, ActivityIndicator, FlatList, SafeAreaView, KeyboardAvoidingView, Button, TouchableOpacity } from "react-native";
...
export const MovieDetailScreen = ({ route }: MovieDetailScreenProps) => {
                    ...
                    <View className="p-[10px]">
                        ...
                        <View>
                            <View className="flex flex-row my-2">
                                <View className="h-fit w-2 bg-sky-500" />
                                <Text className="w-fit ml-2 text-black text-bold text-[24px] font-bold font-[600]">Trailer</Text>
                            </View>
                            <WebView
                                on
                                className="h-56"
